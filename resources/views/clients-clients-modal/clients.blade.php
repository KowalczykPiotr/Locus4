<script src="{{ URL::asset('js/my-scripts/clients-clients-modal.js') }}" type="text/javascript"></script>

<div  ng-controller="clientsAdminCtrl" class="modal fade3" id="modalClient" tabindex="-1" role="dialog" aria-labelledby="modalDelArtConfirmLabel" aria-hidden="true">
