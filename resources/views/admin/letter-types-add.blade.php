    ...
    <div class="p-3">
        <form action="{{ url('/admin/letter-types/save/') }}" role="form" method="post">
            ...
            <div class="form-group row">
                <label for="input-name" class="col-lg-6 control-label text-right">@lang('admin.lab_groupname')</label>
                <div class="col-lg-6">
                    <input id="input-name" name="name" required type="text" class="form-control form-control-sm {{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="@lang('admin.inp_groupname')" value="{{ old('name') }}">
                    @if ($errors->has('name'))
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    <input id="input-sort_order" name="sort_order" required type="text" class="form-control form-control-sm {{ $errors->has('sort_order') ? ' is-invalid' : '' }}" placeholder="@lang('admin.inp_sort_order')" value="{{ old('sort_order') }}">
