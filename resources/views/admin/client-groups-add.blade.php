...
<div class="container mt-5">
    ...
    <form action="{{ url('/admin/customer-groups/save/') }}" role="form" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    <input id="input-group_name" name="group_name" required type="text" class="form-control form-control-sm {{ $errors->has('group_name') ? ' is-invalid' : '' }}" placeholder="@lang('admin.inp_groupname')" value="{{ old('group_name') }}">
